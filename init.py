...
class cosmo_params(object):
    ...
    def __init__(self, label):
        self.label = label
        self.model = "LCDM"
        self.omegamI = 0.2648  # omega_matter
        self.omegavI = 0.0  # omega_lambda
        self.omegaQI = 1.0 - self.omegamI  # 0.7208  # omega_darkenergy
        self.wQI = -1.0  # equation of state of dark energy
        self.wQpI = 0.0  # derivative thereof
        self.hI = 0.71  # Hubble constant in unit of 100 km/s/Mpc
        self.omegakI = (
            1.0 - self.omegamI - self.omegavI - self.omegaQI
        )  # omega_curvature
        self.hubble = 67.11
        ...
        self.omegabI = 0.0448  # Omegab is omega_baryon, for Eisenstein and Hu transfer function (iBBKS=4)
...
class power_params(object):
    ...
    def __init__(self, label):
        ...
        self.keqEH = 0.0  # equality k
        self.sEH = 0.0  # exponent
        self.alphacEH = 0.0  # alpha associated with CDM
        self.betacEH = 0.0  # beta associated with CDM
        self.betanodeEH = 0.0  # beta with the node
        self.alphabEH = 0.0  # alpha associated with baryons
        self.betabEH = 0.0  # beta associated with baryons
        self.ksilkEH = 0.0  # silk damping scale
        self.fracBEH = 0.0  # baryon fraction
        self.fracCEH = 1.0  # CDM fraction
